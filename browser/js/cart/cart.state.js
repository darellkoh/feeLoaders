$(function() {
    ...
    // here
    var username;
    var ospry = new Ospry('pk-test-4zz0h3wuockirbkg8xymtrtm');
    console.log('ospry', ospry);
    ...
    function printMessage(fromUser, message) {
        ...
        if (/^http:\/\/bossy-slug.ospry.io.*$/.test(message)) {
    ...
    // value "browser"
    $.getJSON('http://1f2b2869.ngrok.io/token', {
        identity: username,
        device: 'browser'
    }, function(data) {
        // Alert the user they have been assigned a random username
